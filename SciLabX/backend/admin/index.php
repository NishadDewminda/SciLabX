    ...
    if(isset($_POST['admin_login']))
    {
        ...
        if($rs)
            ...
            #echo "<script>alert('Access Denied Please Check Your Credentials');</script>";
                $err = "Error login Please give valid credentials";
            }
    }
?>
<!--End Login-->
                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="index.php">
                                        <span><img src="assets/images/logo-dark.png" alt="" height="66"></span>
                                    </a>
                                    <p class="text-muted mb-4 mt-3">Enter below details for acces the Admin Panel</p>
                                </div>
